...
export class MovieList extends Component {
  ...
  async componentDidMount() {
    const res = await axios.get(
      `https://api.themoviedb.org/3/movie/popular?api_key=722efcf6249805b7be6fffd194e75902&language=en-US&page=${this.state.currPage}`
    );
  ...
  handlePrevious = () => {
    ...
    for (let j = 1; j< this.state.parr.length ; j++) {
      Arr.push(j);
    }
    console.log(Arr);
